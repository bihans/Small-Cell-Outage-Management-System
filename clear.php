...
<body>
  <div class="main">
      ...
      <form class="form-horizontal" action="clear.php?id=<?php echo $id?>" method="post">
          <div class="row">
            <div class="col-md-2">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group <?php echo !empty($occuredTimeError)?'error':'';?>">
                  ...
                  <div class='input-group date' id='datetimepicker1'>
                    <input class="form-control" name="occuredtime" type='text' placeholder="Occured Time" value="<?php echo $occuredTime;?>" />
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class='input-group date' id='datetimepicker3'>
                    <input class="form-control" name="clearedtime" type='text' placeholder="Cleared Time" value="" required/>
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                  </div>
                ...
                <div class="form-group <?php echo !empty($regionError)?'error':'';?>">
                  ...
                  <input list="brow" name="clearedreason" type="text"  value="<?php echo !empty($clearedCategory)?$clearedCategory:'';?>">
                  <datalist id="brow">
