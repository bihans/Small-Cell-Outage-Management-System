...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM users WHERE username = ? && (user_status ='Approve' OR user_status ='Admin')  ";
        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Do you have admin account? <a class="text-danger " href="admin.php">Login</a></small> </div>
                  </form>
                </div>
            </div>
        </div>
